...
import { Active, BtnFill, CompanyNum, Container, DivideLine, FormControl, InfoForm, InfoFormAuthComplete,
  InfoFormError, MemberPanel, MemberReg, PageTitle, PanelTitle, Wrapper, } from "./MemberInfo.Style";
        ...
        <MemberReg>
          ...
          <MemberPanel>
            ...
            <InfoFormAuthComplete>
              ...
              <span>
                {businessNumberError && businessNumberError?.data[0].tax_type}
              </span>
              <BtnArea>
                <BtnDefault>
